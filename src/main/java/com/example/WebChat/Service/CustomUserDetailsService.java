 ...
 *
 * 🧩 This is where your app's User entity meets Spring Security's authentication model.
 */
@Service
...
public class CustomUserDetailsService implements UserDetailsService {
     ...
     *
     * @param username the login identifier (e.g., "georgiannos@example.com" or "gdimitrios")
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return org.springframework.security.core.userdetails.User
                .withUsername(user.getUsername())     // 👈 "sub" in JWT, principal name
