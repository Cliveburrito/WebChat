...
import com.example.WebChat.security.JwtAuthenticationFilter;
...
class JwtAuthenticationFilterTest {
    ...
    void setUp() {
        ...
        lenient().when(appProperties.getTracking()).thenReturn(tracking);
    }
    ...
    void shouldNotAuthenticateWithInvalidToken() throws Exception {
        ...
        doThrow(new io.jsonwebtoken.JwtException("invalid")).when(jwtService).validateTokenOrThrow(token);
